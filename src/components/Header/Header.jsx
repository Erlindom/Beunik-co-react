    ...
    render() {
        return (
            ...
            <svg className="wave" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                <path fill="#fff" fillOpacity="1" d="M0,256L80,266.7C160,277,320,299,480,266.7C640,235,800,149,960,122.7C1120,96,1280,128,1360,144L1440,160L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z">
                </path>
            </svg>
            ...
            <section className="principal-section" id='home'>
                <div className='content_text'>
                    ...
                    <a href="https://www.youtube.com/watch?v=x85UF-X1aq0" target={"blank"} className="link_decoration">
